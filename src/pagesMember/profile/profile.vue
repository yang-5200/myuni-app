  ...
  <view class="viewport">
    ...
    <view class="avatar">
      <view class="avatar-content">
        <image class="image" @tap="onAvatarChange" :src="profile?.avatar" mode="aspectFill" />
    ...
    <view class="form">
      ...
      <view class="form-content">
        ...
        <view class="form-item">
          ...
          <picker class="picker" mode="date" start="1900-01-01" :end="new Date().toISOString().split('T')[0]"
            :value="profile?.birthday" @change="onBirthdayChange">
